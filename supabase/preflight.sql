...
with required_columns as (
  select * from (
    values
      ...
      ('transactions', 'workspace_id', 'text'),
      ('transactions', 'created_by_uid', 'text'),
      ...
      ('workspace_members', 'id', 'text'),
      ('workspace_members', 'workspace_uid', 'text'),
      ('workspace_members', 'workspace_id', 'text'),
      ('workspace_members', 'member_uid', 'text'),
      ('workspace_members', 'email', 'text'),
      ('workspace_members', 'display_name', 'text'),
      ('workspace_members', 'member_role', 'text'),
      ('workspace_members', 'permissions', 'ARRAY'),
      ('workspace_members', 'member_status', 'text'),
      ('workspace_members', 'invited_by_uid', 'text'),
      ('workspace_members', 'raw', 'jsonb'),
      ('workspace_members', 'created_at', 'timestamp with time zone'),
      ('workspace_members', 'updated_at', 'timestamp with time zone'),

      ('workspace_invitations', 'id', 'text'),
      ('workspace_invitations', 'workspace_uid', 'text'),
      ('workspace_invitations', 'workspace_id', 'text'),
      ('workspace_invitations', 'email', 'text'),
      ('workspace_invitations', 'member_role', 'text'),
      ('workspace_invitations', 'permissions', 'ARRAY'),
      ('workspace_invitations', 'invitation_status', 'text'),
      ('workspace_invitations', 'invited_by_uid', 'text'),
      ('workspace_invitations', 'invited_member_uid', 'text'),
      ('workspace_invitations', 'expires_at', 'timestamp with time zone'),
      ('workspace_invitations', 'raw', 'jsonb'),
      ('workspace_invitations', 'created_at', 'timestamp with time zone'),
      ('workspace_invitations', 'updated_at', 'timestamp with time zone'),

      ('payment_cards', 'id', 'text'),
      ('payment_cards', 'uid', 'text'),
      ('payment_cards', 'workspace_id', 'text'),
      ...
      ('piggy_bank_history', 'workspace_id', 'text'),
      ...
      ('support_requests', 'client_request_id', 'text'),
      ('support_requests', 'protocol', 'text'),
      ('support_requests', 'workspace_id', 'text'),
      ('support_requests', 'workspace_type', 'text'),
      ('support_requests', 'effective_plan', 'text'),
      ('support_requests', 'report_route', 'text'),
      ('support_requests', 'app_version', 'text'),
      ('support_requests', 'browser', 'text'),

      ('support_request_attachments', 'id', 'text'),
      ('support_request_attachments', 'ticket_id', 'text'),
      ('support_request_attachments', 'owner_uid', 'text'),
      ('support_request_attachments', 'storage_path', 'text'),
      ('support_request_attachments', 'mime_type', 'text'),
      ('support_request_attachments', 'size_bytes', 'bigint'),
      ('support_request_attachments', 'sha256', 'text'),
      ('support_request_attachments', 'width', 'integer'),
      ('support_request_attachments', 'height', 'integer'),
      ('support_request_attachments', 'scan_status', 'text'),
      ('support_request_attachments', 'visibility', 'text'),
      ('support_request_attachments', 'retention_until', 'timestamp with time zone'),
      ('support_request_attachments', 'created_at', 'timestamp with time zone'),
      ('support_request_attachments', 'updated_at', 'timestamp with time zone'),

      ('support_request_messages', 'id', 'text'),
      ('support_request_messages', 'ticket_id', 'text'),
      ...
      ('support_request_events', 'id', 'text'),
      ('support_request_events', 'ticket_id', 'text'),
      ('support_request_events', 'actor_uid', 'text'),
      ('support_request_events', 'event_type', 'text'),
      ('support_request_events', 'visibility', 'text'),
      ('support_request_events', 'metadata', 'jsonb'),
      ('support_request_events', 'created_at', 'timestamp with time zone'),
      ...
      ('processed_events', 'id', 'text'),
      ('processed_events', 'provider', 'text'),
      ('processed_events', 'created_at', 'timestamp with time zone'),

      ('subscriptions', 'uid', 'text'),
      ('subscriptions', 'provider', 'text'),
      ('subscriptions', 'provider_subscription_id', 'text'),
      ('subscriptions', 'plan', 'text'),
      ('subscriptions', 'status', 'text'),
      ('subscriptions', 'current_period_end', 'timestamp with time zone'),
      ('subscriptions', 'raw', 'jsonb'),
