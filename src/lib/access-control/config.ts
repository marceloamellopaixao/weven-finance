...
export const ACCESS_SCREENS: AccessScreenDefinition[] = [
  ...
  },
  {
    ...
    label: "Administração",
    route: "/admin",
    description: "Usuários, suporte, restauração, planos e permissões.",
    resources: [
      ...
      { key: "admin.plans.write", label: "Planos · editar", description: "Permite alterar preços, benefícios e regras comerciais dos planos." },
      ...
      { key: "admin.pages.preview", label: "Pré-visualizar páginas restritas", description: "Permite abrir manualmente telas condicionais como login, cadastro, bloqueio, verificação, primeiro acesso e despedida para auditoria." },
