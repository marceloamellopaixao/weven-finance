...
export const NAVIGATION_APP_ITEMS: NavigationAppItem[] = [
  {
    ...
    label: "Dashboard",
    shortLabel: "Painel",
    description: "Sua visao geral do mes, saldo, previsao e extrato financeiro.",
    href: "/dashboard",
  ...
  },
  {
    ...
    label: "Cartoes",
    shortLabel: "Cartoes",
    description: "Acompanhe limites, faturas, debito e credito em um so lugar.",
    href: "/cards",
    icon: CreditCard,
  ...
  },
  {
    ...
    label: "Porquinho",
    shortLabel: "Metas",
    description: "Crie metas, acompanhe aportes e visualize sua evolucao.",
    href: "/piggy-bank",
    icon: PiggyBank,
  ...
  },
  {
    ...
    label: "Explorar app",
    shortLabel: "Apps",
    description: "Veja todas as areas do WevenFinance e personalize seus atalhos.",
    href: "/apps",
    icon: Grid2X2,
