...
> = {
  violet: {
    ...
    darkSolid: "border-violet-500/25 bg-linear-to-br from-violet-950 via-violet-900 to-fuchsia-950 text-zinc-100 shadow-violet-950/35",
    darkGlass: "border-violet-400/25 bg-linear-to-br from-violet-950/90 via-violet-900/80 to-fuchsia-950/86 text-zinc-100 shadow-violet-950/30 backdrop-blur-2xl",
  ...
  indigo: {
    ...
    darkSolid: "border-indigo-500/25 bg-linear-to-br from-indigo-950 via-indigo-900 to-blue-950 text-zinc-100 shadow-indigo-950/35",
    darkGlass: "border-indigo-400/25 bg-linear-to-br from-indigo-950/90 via-indigo-900/80 to-blue-950/86 text-zinc-100 shadow-indigo-950/30 backdrop-blur-2xl",
  ...
  fuchsia: {
    ...
    darkSolid: "border-fuchsia-500/25 bg-linear-to-br from-fuchsia-950 via-fuchsia-900 to-violet-950 text-zinc-100 shadow-fuchsia-950/35",
    darkGlass: "border-fuchsia-400/25 bg-linear-to-br from-fuchsia-950/90 via-fuchsia-900/80 to-violet-950/86 text-zinc-100 shadow-fuchsia-950/30 backdrop-blur-2xl",
  ...
  emerald: {
    ...
    darkSolid: "border-emerald-500/25 bg-linear-to-br from-emerald-950 via-emerald-900 to-teal-950 text-zinc-100 shadow-emerald-950/35",
    darkGlass: "border-emerald-400/25 bg-linear-to-br from-emerald-950/90 via-emerald-900/80 to-teal-950/86 text-zinc-100 shadow-emerald-950/30 backdrop-blur-2xl",
  ...
  amber: {
    ...
    darkSolid: "border-amber-500/25 bg-linear-to-br from-amber-950 via-orange-900 to-amber-900 text-zinc-100 shadow-amber-950/35",
    darkGlass: "border-amber-400/25 bg-linear-to-br from-amber-950/90 via-orange-900/80 to-amber-900/86 text-zinc-100 shadow-amber-950/30 backdrop-blur-2xl",
