            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-xs text-primary transition-all duration-200 hover:cursor-pointer hover:underline"
                >
                  {tLogin("forgot")}
                </Link>
              </div>
          ...
          <div className="pt-2 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link
                ...
                className="font-semibold text-primary transition-all duration-200 hover:cursor-pointer hover:underline"
              >
                {tLogin("signUp")}
              </Link>
            </p>
